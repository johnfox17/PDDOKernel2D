import numpy as np
import zerothOrderDerivativePDDOKernel as PDDOKernel0thOrder
...
def main():
    ...
    PDDOKernel0th = PDDOKernel0thOrder.zerothOrderDerivativePDDOKernel()
    PDDOKernel0th.solve()
    ...
    np.savetxt('../data/output/g00_0.005.csv', PDDOKernel0th.g00, delimiter=",")
